...
class EntryViewsTests(TestCase):
    ...
    def test_entry_detail_view(self):
        note = Note.objects.create(title="Test", content="test", author=self.user)
    ...
    def test_entry_update_view(self):
        entry = Note.objects.create(title="Test", content="test", author=self.user)
        response = self.client.post(
    ...
    def test_entry_delete_view(self):
        entry = Note.objects.create(title="Testdel", content="delete", author=self.user)
